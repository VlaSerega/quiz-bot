...
aq = [Question('Ты уже в музее Германа Титова в селе Полковниково?',
      ...
      Question(
          'Верно! Это Чуйский тракт! Самая красивая дорога Сибири, ТОП -10 дорог мира по версии National Geographic, транспортная артерия, по которой издревле ходили караваны с товара из Сибири в Монголию, Китай, Казахстан! Чтобы выполнить следующее задание, нужно внимательно слушать экскурсовода. Готов погрузиться в историю Чуйского тракта?',
          QuestionType.one, answers=['Да', 'Нет'], incor_action=Action.next, cor_answer='Да',
