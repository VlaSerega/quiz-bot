...
aq = [Question('Ты уже в музее Германа Титова в селе Полковниково?',
      ...
      Question(
          ...
          'А теперь НАШ долгожданный КОНКУРС <a href="https://t.me/+Dk7LT5zYUyYzMzMy">🏆</a>!\nТы же успел сделать много классных фото в поездке?\nВыбирай 4 самых лучших, с самыми яркими эмоциями!\nБудет здорово если в кадр попадет  «герой» или «герои».\nОтправляй мне фотографии и жди результаты!\n'
