...
quest = [
    ...
    Question('Ты разработал бизнес-план на несколько лет, а он "провалился". Твои действия:\n\n'
             ...
             answers=['1', '2', '3'], cor_answer='2'),
    Question(
        'У вашего друга товарища затруднительная ситуация. Он хочет занять у вас 1000 золотых, обещая вернуть через год. Твои действия:\n\n'
